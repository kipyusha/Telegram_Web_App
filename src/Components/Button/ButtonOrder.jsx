...
const ButtonOrder = ({cartItems, onAdd, onRemove, updateCartItems, deleteItem}) => {
  ...
  return ( 
    <div className="cart__container">
      ...
      <Cart isOpen={isCartOpen} onClose={closeCart} cartItems={cartItems} totalPrice={totalPrice} deleteItem={deleteItem} onAdd={onAdd} onRemove={onRemove} updateCartItems={updateCartItems}/>
    </div>
